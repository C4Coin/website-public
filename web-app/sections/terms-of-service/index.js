...
export default function TermsOfServervice({ ...rest }) {
  return (
    <Page className={s['container']}>
      <div className={s['display']}>
        <h2>Terms of Service</h2>
        <p>
          IMPORTANT MESSAGE: www.c4coin.org (the “Site”) is a website owned and
          operated by CO2KN, INC (CO2KN). By accessing this Site and any pages
          on this Site, you agree to be bound by its Terms of Use and Privacy
          Policy, as may be amended from time to time without notice or
          liability. Investment opportunities posted on the Site are
          “test-the-waters” communications by CO2KN to gauge interest in a
          future offering of the company’s securities. CO2KN is not an
          investment advisor, broker-dealer or crowdfunding portal and does not
          engage in any activities requiring any such registration. The proposed
          securities offerings posted on the Site are available to all
          investors. Please be aware that (1) no money or other consideration is
          being solicited, and if sent, will not be accepted; (2) no sales will
          be made or commitments to purchase accepted until the offering
          statement for a financing is qualified by the US Securities and
          Exchange Commission; and (3) a prospective purchaser’s indication of
          interest is non-binding. The “test-the-waters” information presented
          on this Site are for potential securities offerings pursuant to
          Regulation A that provides an exemption from the registration
          requirements of the Securities Act of 1933, as amended. The company
          materials are not required to comply with specific disclosure
          ...
          regulator or other regulatory body has passed upon the merits of or
          given its approval to the securities, the terms of the offerings, or
          the accuracy or completeness of any offering materials. Neither CO2KN,
          INC nor any of its directors, officers, employees, representatives,
          affiliates, or agents shall have any liability whatsoever arising from
          any error or incompleteness of fact or opinion in, or lack of care in
          the preparation or or publication of, the materials and communication
          herein or the valuation of any securities offering. CO2KN, INC does
          not give investment advice or recommendations regarding any offering
          posted on the Site. Prior results are not indicative of future
          performance; actual results may vary materially. The Site may contain
          “forward looking statements” which are not guaranteed. All investors
        ...
        <h5>C4Coin Terms of Service and Privacy Policy</h5>
        <h6>1. Terms</h6>
        <p>
          By accessing the website at http://www.c4coin.org, you are agreeing to
        ...
        <p>
          ...
          these restrictions and may be terminated by C4Coin at any time. Upon
        ...
        <p>
          C4Coin may revise these terms of service for its website at any time
